...
exports.default = _default;
  ...
  return _c("div", { staticClass: "big-header" }, [
    ...
    _c("br"),
    _vm._v(" "),
    _c("h2", [_c("p", [_vm._v(_vm._s(_vm.description))])]),
    _vm._v(" "),
    _c(
      "div",
      { staticClass: "text" },
...
exports.default = _default;
  ...
  return _c("div", { staticClass: "big-header" }, [
    _c("h1", [
      _vm._v(
        "Selectionez un personnage à l'aide de votre curseur pour commencer a jouer"
      )
    ]),
    _vm._v(" "),
    _c(
...
var _default = {
  ...
  methods: {
    ...
    itemChoice: function itemChoice(items, link) {
  ...
  return _c(
    ...
    [
          ...
          _vm._l(_vm.answers, function(answer) {
            return _c(
              "p",
              {
                ...
                on: {
                  click: function($event) {
                    return _vm.itemChoice(answer.items, answer.link)
                  }
                }
              },
      ...
      _c("section", { staticClass: "money" }, [
        ...
        _vm._v(" "),
        _c("p", [_vm._v(_vm._s(_vm.items.money))])
      ])
    ]
  )
}
